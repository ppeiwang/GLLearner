...
int main()
{
	...
	*/
	...
	const std::string texture_diffuse_path{"texture/container2.png"};
	const std::string texture_specular_path{"texture/container2_specular.png"};

	ShaderLoader shader_cube_on_light{ R"(shader/vs_texture.glsl)", R"(shader/fs_cube_on_light.glsl)" };
